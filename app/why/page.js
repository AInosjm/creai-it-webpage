    ...
    <div className="w-full">
      <div className="relative bg-gradient-to-r from-navy to-sky-900 py-16 sm:py-32 px-4 sm:px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-6xl font-extrabold text-white mb-6 sm:mb-8 animate-slideUp">Why CREAI+IT</h1>
          <p className="text-lg sm:text-xl text-white/90 leading-relaxed animate-slideUp delay-100">
            LLM 중심의 Generative AI가 만들어내는 격변의 시대,<br className="hidden sm:block" />
            기술적 역량과 사업적 역량을 결합하여<br className="hidden sm:block" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-24 space-y-12 sm:space-y-24">
        <section className="animate-slideUp">
          <h2 className="text-3xl sm:text-4xl font-bold gradient-text mb-8 sm:mb-12">변화의 속도, 변화의 기회</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-100">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">급격한 기술 발전</h3>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-100">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">진지한 접근</h3>
              <div className="space-y-3">
                <p className="text-sm sm:text-base text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-100">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">실질적 접근</h3>
              <div className="space-y-3">
                <p className="text-sm sm:text-base text-gray-600">
        ...
        <section className="animate-slideUp">
          <h2 className="text-3xl sm:text-4xl font-bold gradient-text mb-8 sm:mb-12">핵심 가치의 실천</h2>
          <div className="space-y-6 sm:space-y-8">
            <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-xl border border-gray-100">
              <h3 className="text-xl sm:text-2xl font-bold text-navy mb-6">Edge Tech</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                <div className="pl-4 sm:pl-6 border-l-4 border-sky-500">
                  <h4 className="text-lg sm:text-xl font-semibold mb-4">최신 기술 실습</h4>
                  <ul className="space-y-3 text-sm sm:text-base text-charcoal">
                ...
                <div className="pl-4 sm:pl-6 border-l-4 border-sky-500">
                  <h4 className="text-lg sm:text-xl font-semibold mb-4">트렌드 추적</h4>
                  <ul className="space-y-3 text-sm sm:text-base text-charcoal">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-xl border border-gray-100">
              <h3 className="text-xl sm:text-2xl font-bold text-navy mb-6">Sensitivity</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                <div className="pl-4 sm:pl-6 border-l-4 border-sky-500">
                  <h4 className="text-lg sm:text-xl font-semibold mb-4">시장 가치 발굴</h4>
                  <ul className="space-y-3 text-sm sm:text-base text-charcoal">
                ...
                <div className="pl-4 sm:pl-6 border-l-4 border-sky-500">
                  <h4 className="text-lg sm:text-xl font-semibold mb-4">통합적 사고</h4>
                  <ul className="space-y-3 text-sm sm:text-base text-charcoal">
                    <li>• 기술과 비즈니스의 결합</li>
                    <li>• 문제 발견과 해결책 도출</li>
                    <li>• 가치 창출 감각 체화</li>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-xl border border-gray-100">
              <h3 className="text-xl sm:text-2xl font-bold text-navy mb-6">Value Creation</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                <div className="pl-4 sm:pl-6 border-l-4 border-sky-500">
                  <h4 className="text-lg sm:text-xl font-semibold mb-4">Zero to One</h4>
                  <p className="text-sm sm:text-base text-charcoal">
                    아이디어 발굴부터 시장 검증까지, 실제 창업 프로세스를 경험합니다.
                  </p>
                </div>
                <div className="pl-4 sm:pl-6 border-l-4 border-sky-500">
                  <h4 className="text-lg sm:text-xl font-semibold mb-4">실전 프로젝트</h4>
                  <p className="text-sm sm:text-base text-charcoal">
                    팀 프로젝트와 외부 피드백을 통해 아이디어를 현실화합니다.
                  </p>
                </div>
                <div className="pl-4 sm:pl-6 border-l-4 border-sky-500">
                  <h4 className="text-lg sm:text-xl font-semibold mb-4">지속적 성장</h4>
                  <p className="text-sm sm:text-base text-charcoal">
        ...
        <section className="animate-slideUp">
          <h2 className="text-3xl sm:text-4xl font-bold gradient-text mb-8 sm:mb-12">성과와 활동</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-100">
              <div className="w-12 h-12 bg-sky-100 rounded-xl mb-6 flex items-center justify-center">
        ...
        <section className="animate-slideUp text-center">
          <h2 className="text-3xl sm:text-4xl font-bold gradient-text mb-6 sm:mb-8">Join CREAI+IT</h2>
          <p className="text-lg sm:text-xl text-gray-700 mb-8 sm:mb-12 max-w-3xl mx-auto">
            혼자서는 얻기 어려운 귀중한 경험,<br className="hidden sm:block" />
            함께라면 LLM과 Generative AI의 무한한 가능성을<br className="hidden sm:block" />
            실질적 가치로 바꿔낼 수 있습니다.
          </p>
          <a
            href="/join"
            className="inline-block bg-navy hover:bg-sky-900 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-xl transition-colors"
          >
            지원하기
          </a>
        </section>
