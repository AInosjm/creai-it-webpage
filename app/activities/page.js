      ...
      <div className="max-w-6xl mx-auto px-6 py-24 space-y-24">
        ...
        <section className="animate-fadeInUp">
          <div className="flex items-center space-x-4 mb-12">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-sky-500 to-blue-600 flex items-center justify-center text-sky-dark font-bold">1</div>
            <h2 className="text-4xl font-bold gradient-text">전반기: Agents & Problem Discovery</h2>
          </div>
          ...
          <div className="bg-white rounded-2xl p-12 shadow-xl border border-gray-100">
            <div className="space-y-12">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Problem Discovery & Implementation</h3>
                <div className="pl-6 border-l-4 border-sky-500 space-y-8">
                  <div>
                    <h4 className="text-xl font-semibold text-gray-800 mb-3">문제 발굴 방법론</h4>
                    <ul className="space-y-3 text-lg text-gray-600">
        ...
        <section className="animate-fadeInUp">
          <div className="flex items-center space-x-4 mb-12">
            ...
            <h2 className="text-4xl font-bold gradient-text">후반기: Advanced AI & Market Validation</h2>
          </div>

          <div className="bg-white rounded-2xl p-12 shadow-xl border border-gray-100">
            <div className="space-y-12">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">심화 LLM Application</h3>
                <div className="pl-6 border-l-4 border-sky-500 space-y-8">
                  <div>
                    <h4 className="text-xl font-semibold text-gray-800 mb-3">최신 기술 트렌드 & 구현</h4>
                    <ul className="space-y-3 text-lg text-gray-600">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">시장 검증 & 성장 전략</h3>
                <div className="pl-6 border-l-4 border-sky-500 space-y-8">
                  <div>
                    <h4 className="text-xl font-semibold text-gray-800 mb-3">Lean Startup 실전 적용</h4>
                    <ul className="space-y-3 text-lg text-gray-600">
        ...
        {/* 추가 활동 섹션 */}
        <section className="animate-fadeInUp">
          <h2 className="text-4xl font-bold gradient-text mb-12 text-center">Growth Support Program</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Industry Network</h3>
              <p className="text-gray-600">AI 대기업 엔지니어, VC, 스타트업 CEO들과의 정기적인 교류 및 멘토링 기회 제공</p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100">
              <div className="w-12 h-12 bg-gradient-to-br from-sky-500 to-blue-600 rounded-xl mb-4 flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Startup Support</h3>
              <p className="text-gray-600">프로젝트당 최대 1,500만원 지원금, AWS/GCP 크레딧, 개발 장비 및 공간 제공</p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100">
              <div className="w-12 h-12 bg-gradient-to-br from-sky-500 to-blue-600 rounded-xl mb-4 flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Alumni Community</h3>
              <p className="text-gray-600">수료 후 Alumni 네트워크 참여, 후속 프로젝트 지원 및 창업 연계 프로그램 제공</p>
            </div>
          </div>
        </section>
      </div>
